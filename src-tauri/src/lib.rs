...
#[cfg(target_os = "linux")]
fn should_force_webkit_compositing(
    dmabuf_renderer_disabled: bool,
    compositing_preference_configured: bool,
) -> bool {
    dmabuf_renderer_disabled && !compositing_preference_configured
}
...
pub fn configure_linux_webkit_rendering_before_startup() {
    ...
    if should_force_webkit_compositing(
        ...
        eprintln!("Unable to restart with forced WebKit compositing: {error}");
...
mod tests {
    ...
    #[cfg(target_os = "linux")]
    #[test]
    fn forces_compositing_only_for_an_unconfigured_non_dmabuf_renderer() {
        assert!(should_force_webkit_compositing(true, false));
        assert!(!should_force_webkit_compositing(false, false));
        assert!(!should_force_webkit_compositing(true, true));
    }
